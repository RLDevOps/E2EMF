...
(function () {
    ...
    Sankey = (function () {
        ...
        Sankey.prototype.draw = function (obj) {
            ...
            for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
                ...
                if (box.size() > this.threshold_for_drawing) {
                    _results.push(box.draw(this.r, obj));
                } else {
    ...
    TransformationBox = (function () {
        ...
        TransformationBox.prototype.draw = function (r, obj) {
            var box_width, callback = obj, o = this,
		  lab = this.descriptionLabelText(),
		  left_lines = this.left_lines,
		  right_lines = this.right_lines;
            ...
            this.box = r.rect(this.x, this.y, box_width, this.size()).attr({
                ...
                callback.call(this, lab, left_lines, right_lines);
          //      $('#myModal').modal('show');  
          //      $('#ponumber').append(lab.toString());
