(function () {
    ...
    Sankey = (function () {
        function Sankey() {
            ...
            this.stack_ref_hash = {}; //Variable added by Mani
        }
        ...
        Sankey.prototype.stack = function (x, box_names, y_box) {
            //Following block added by Mani
            for (id in box_names) {
                this.stack_ref_hash[box_names[id]] = x;
            }
            //End
    ...
    FlowLine = (function () {
        function FlowLine(sankey, left_box_name, flow, right_box_name) {
            ...
            this.click = __bind(this.click, this); //Line added by Mani
            this.setFlow(flow);
            this.colour = void 0;
            this.ox = 0;
            this.oy = 0;
        ...
        FlowLine.prototype.draw = function (r) {
            ...
            //Changed by Mani
            //Old line:  r.set().push(this.inner_line, this.outer_line).hover(this.hover_start, this.hover_stop)
            var x = r.set().push(this.inner_line, this.outer_line);
            x.hover(this.hover_start, this.hover_stop);
            x.click(this.click);
            //End changes
        ...
        //Following function added by Mani
        FlowLine.prototype.click = function (event) {
            var keyword2 = (this.sankey.stack_ref_hash[this.left_box.name] + " " + this.left_box.name + "," + this.sankey.stack_ref_hash[this.right_box.name] + " " + this.right_box.name);

            //sessionStorage.clear();
            sessionStorage.setItem("mykeyword", keyword2);
            runDataTables();
          //  return true;
        };
    ...
    TransformationBox = (function () {
        ...
        TransformationBox.prototype.draw = function (r) {
            ...
            //Changed by Mani
            //Old line: return r.set().push(this.number_label, this.label, this.box, this.bubble_circle, this.bubble_label).hover(this.hover_start, this.hover_end);
            var x = r.set().push(this.number_label, this.label, this.box, this.bubble_circle, this.bubble_label);
            x.click(this.click);
            return x.hover(this.hover_start, this.hover_end);
            //End changes
        };
        ...
        //Following function added by Mani
        TransformationBox.prototype.click = function () {
            var keyword = this.sankey.stack_ref_hash[this.name] + " " + this.name;
